...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.active{background-color:#7fffd4}`, ""]);
// Exports
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([{id:'dummyTable',title:'Dummy Table',order:1,path:'./tabs/dummyTable.tsx'},{id:'dummyChart',title:'Dummy Chart',order:2,path:'./tabs/dummyChart.tsx'},{id:'dummyList',title:'Dummy List',order:0,path:'./tabs/dummyList.tsx'}]);
...
function useDataRouterContext(hookName) {
  let ctx = react__WEBPACK_IMPORTED_MODULE_0__.useContext(react_router__WEBPACK_IMPORTED_MODULE_2__/* .UNSAFE_DataRouterContext */ .w3);
...
function useViewTransitionState(to, opts) {
  ...
  !(vtContext != null) ?  false ? 0 : (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .UNSAFE_invariant */ .J0)(false) : void 0;
  let {
    basename
  ...
  let currentPath = (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .stripBasename */ .Zn)(vtContext.currentLocation.pathname, basename) || vtContext.currentLocation.pathname;
  let nextPath = (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .stripBasename */ .Zn)(vtContext.nextLocation.pathname, basename) || vtContext.nextLocation.pathname;
  ...
  return (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .matchPath */ .LX)(path.pathname, nextPath) != null || (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .matchPath */ .LX)(path.pathname, currentPath) != null;
}
//#endregion
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(514);
/* harmony import */ var _tabs_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(443);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(250);





const getLazyComponent = (pathStr) => {
    return (0,react__WEBPACK_IMPORTED_MODULE_1__.lazy)(() => __webpack_require__(643)(`${pathStr}`));
};
const renderTab = (path) => {
    const Tab = getLazyComponent(path);
    return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Tab, {});
};
const App = () => {
    const defaultTab = _tabs_json__WEBPACK_IMPORTED_MODULE_3__["default"].find((tab) => tab.order === 0);
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__.Header, {}), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__.ErrorBoundaryElem, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react__WEBPACK_IMPORTED_MODULE_1__.Suspense, { fallback: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components__WEBPACK_IMPORTED_MODULE_2__.Loading, {}), children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_router_dom__WEBPACK_IMPORTED_MODULE_4__/* .Routes */ .Z5, { children: [defaultTab && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_4__/* .Route */ .AW, { path: "/", element: renderTab(defaultTab.path) }), _tabs_json__WEBPACK_IMPORTED_MODULE_3__["default"].map((tabObj) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_4__/* .Route */ .AW, { path: `/${tabObj.id}`, element: renderTab(tabObj.path) }, tabObj.id)))] }) }) })] }));
};
...
class ErrorBoundaryElem extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    constructor(props) {
        super(props);
        this.state = {
            isError: false,
    ...
    render() {
        ...
        if (isError) {
            return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { children: "Opps! Something went wrong" });
        }
        return children;
    }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ErrorBoundaryElem);
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(893);
/* harmony import */ var _tabs_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(443);
/* harmony import */ var _NavElem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(40);



const Header = () => {
    const sortedTabsArr = _tabs_json__WEBPACK_IMPORTED_MODULE_1__["default"].sort((tabDataPrev, tabDataNext) => {
        return tabDataPrev.order - tabDataNext.order;
    });
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("header", { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("h1", { children: "Header" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("nav", { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("ul", { style: { padding: '0' }, children: sortedTabsArr.map((tabData) => ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_NavElem__WEBPACK_IMPORTED_MODULE_2__.NavElem, { tabData: tabData }, tabData.id))) }) })] }));
};
...
function Loading() {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("i", { children: "Loading..." }) }));
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NavElem: () => (/* binding */ NavElem)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(893);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(250);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(655);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(294);
...
const NavElem = (props) => {
    const { tabData } = props;
    const [isDefaultActive, setIsDefaultActive] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
    const location = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_2__/* .useLocation */ .TH)();
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
        const newPathname = location.pathname.slice(1);
        setIsDefaultActive(!newPathname);
    }, [location]);
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("li", { style: { padding: '5px', listStyle: 'none', display: 'inline' }, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_3__/* .NavLink */ .OL, { to: `/${tabData.id}`, className: ({ isActive }) => {
                if (!tabData.order) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ErrorBoundaryElem: () => (/* reexport safe */ _ErrorBoundary__WEBPACK_IMPORTED_MODULE_0__["default"]),
...
/* harmony export */ });
/* harmony import */ var _ErrorBoundary__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(785);
/* harmony import */ var _Header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(84);
/* harmony import */ var _Loading__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(683);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "backendless-test-task:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbackendless_test_task"] = self["webpackChunkbackendless_test_task"] || [];
...
// EXTERNAL MODULE: ./src/script/App.tsx
var App = __webpack_require__(536);
...
var update = injectStylesIntoStyleTag_default()(styles/* default */.Z, options);
       ...
       /* harmony default export */ const sass_styles = (styles/* default */.Z && styles/* default */.Z.locals ? styles/* default */.Z.locals : undefined);
